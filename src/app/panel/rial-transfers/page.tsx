...
const Page = () => {
    ...
    // ✅ ستون‌ها با استایل مدرن‌تر برای Table
    const columns = useMemo(() => {
        return [
          ...
          },
          {
            ...
            cell: (row: IrrTransactionRow) => (
              <span
                className="font-mono text-xs text-slate-700 dark:text-slate-200 max-w-[180px] truncate whitespace-nowrap"
                title={row?.transactionReferenceId}
              >
          ...
          },
          {
            ...
            cell: (row: IrrTransactionRow) => {
              const text = translateTransactionStatus(row?.transactionStatus);
              const color =
                row?.transactionStatus === 'SUCCESS'
                  ? 'bg-[#63C3FF]/10 text-[#63C3FF] dark:bg-[#63C3FF]/20'
          ...
          },
          {
            ...
            cell: (row: IrrTransactionRow) => (
              <span
                className="font-mono text-xs text-slate-700 dark:text-slate-200 max-w-[180px] truncate whitespace-nowrap"
                title={row?.exchangeAcctData}
              >
                {row?.exchangeAcctData || '—'}
              </span>
            ),
          },
          {
      ...
      "
                    >
                        ...
                        <div className="flex items-center justify-between mb-4">
                            <div className="text-lg font-semibold text-titleText dark:text-titleText-dark">
                                فیلترهای بیشتر
                            </div>
