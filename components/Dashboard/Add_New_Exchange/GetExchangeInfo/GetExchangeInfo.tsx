...
const GetExchangeInfo: React.FC<GetExchangeInfoProps> = ({ SetStep, ID, setID }) => {
    ...
    const nextStep = async () => {
        ...
        if (email !== '' && email !== null && !validateEmail(email)) { return toast.error("ایمیل مورد نظر را به درستی وارد کنید", { position: "bottom-left" })}
    ...
    return (
        <div className='mt-4 mb-4'>
            ...
            <div className='sm:bg-boxColor sm:dark:bg-boxColor-dark sm:border sm:border-boxBorderColor sm:dark:border-boxBorderColor-dark rounded-xl mt-4 sm:p-4'>
