...
const EmployeeInfo = () => {
    ...
    const data: Person[] = [
        { id: "5", name: "محمد", startDate:'1404/04/04', insuranceStartDate:'1404/04/04', insuranceEndDate:'1404/04/04', role: "رئیس هیئت‌مدیره", phoneNumber: "09121234567", nationalCode: '1400765432', educationHistory: '4040404040', careerHistory: '9129991111', sharePercentage:'30', email:'' },
        { id: "5", name: "محمد", startDate:'1404/04/04', insuranceStartDate:'1404/04/04', insuranceEndDate:'1404/04/04', role: "رئیس هیئت‌مدیره", phoneNumber: "09121234567", nationalCode: '1400765432', educationHistory: '4040404040', careerHistory: '9129991111', sharePercentage:'30', email:'' },
        { id: "5", name: "محمد", startDate:'1404/04/04', insuranceStartDate:'1404/04/04', insuranceEndDate:'1404/04/04', role: "رئیس هیئت‌مدیره", phoneNumber: "09121234567", nationalCode: '1400765432', educationHistory: '4040404040', careerHistory: '9129991111', sharePercentage:'30', email:'' },
    ];
